        ...
        <div className="small-container px-3 px-md-0 mx-auto py-5">
          <div className="d-flex align-items-center justify-content-center">
            ...
            <a href="https://github.com/hermanya/react-blob">
              <Blob size="2em" className="bg-dark text-white">
          ...
          <section className="mb-4 text-center animated bounceInUp delay-01s">
            <h1 className="display-4 text-muted">
              React component that looks like <strong>liquid in space</strong>
            </h1>
          </section>
          <div className="row">
            <section className="col animated bounceInUp delay-02s">
              ...
              <pre className="bg-dark text-success p-3 rounded">
                <code>npm install --save react-blob</code>
              </pre>
              <a href="https://www.npmjs.com/package/react-blob">
                <img
                  src="https://img.shields.io/npm/v/react-blob.svg"
                  alt="npm version"
                  className="mr-2"
                />
              </a>
